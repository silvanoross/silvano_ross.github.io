...
#### KEGG (Kyoto Encyclopedia of Genes and Genomes) Pathways for Abundant Peptides
...
kegg_abundant <-  ggplot(plot_df, aes(x = reorder(Term, Count), 
  ...
  labs(x = "Pathway", y = "Gene Count", fill = "Adj. P-value",
       title = "KEGG Pathway Most Abundant") +
  theme_cowplot()
...
reactome_plot |>
  ggsave(filename = "plots/reactome_intense.png", width = 12, height = 8, dpi = 300)

```
### Side by Side of KEGG Pathways: Most Abundant vs Most Intense
```{r, fig.width=20, fig.height=8}
plot_grid(kegg_abundant, kegg_intense)
```
